export const agents = [
  ...
  },
  {
    ...
    role: "Le Logisticien",
    color: "#3b82f6",
    description: "A trouvé la maison à Meudon. A tout coordonné avec son bras droit : Google Maps.",
  ...
  },
  {
    ...
    role: "L'Ingénieur",
    color: "#8b5cf6",
    description: "A réservé tous les restaurants du week-end. S'est occupé de toute la logistique nourriture. A tout validé depuis Lyon.",
  ...
  },
  {
    ...
    color: "#10b981",
    description: "Père de famille, comédien, stratège. Architecte en chef du faux casting. A improvisé une fausse gaffe en live. Génie ou inconscient.",
