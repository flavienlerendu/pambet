export const agents = [
  ...
  },
  {
    ...
    role: "Le Logisticien",
    color: "#3b82f6",
    description: "A trouvé la maison à Meudon. A loué les costumes de Tortues Ninja. A tout coordonné avec son bras droit : Google Maps.",
  ...
  },
  {
    ...
    color: "#10b981",
    description: "Père de famille, comédien, stratège. A organisé le faux casting. A improvisé une fausse gaffe en live. Génie ou inconscient.",
